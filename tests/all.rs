...
fn iter_concurrent_limit_all(concurrent_limit: usize) {
    ...
    let output = iter_concurrent_limit!(concurrent_limit, 0..10, all, |i| -> bool {
    ...
    assert_eq!(output, (0..10).into_iter().all(|i| i == 5));
...
#[test]
fn iter_concurrent_limit_all_1() {
    iter_concurrent_limit_all(1);
}

#[test]
fn iter_concurrent_limit_all_2() {
    iter_concurrent_limit_all(2);
}

#[cfg_attr(feature = "ci", ignore)]
#[test]
fn iter_concurrent_limit_all_4() {
    iter_concurrent_limit_all(4);
}
