...
fn any_concurrent_limit(concurrent_limit: usize) {
    ...
    let output = (0..10)
        .into_par_iter()
        .any_concurrent_limit(concurrent_limit, |i| {
    ...
    assert_eq!(output, (0..10).any(|i| i == 5));
...
#[test]
fn any_concurrent_limit_1() {
    any_concurrent_limit(1);
}

#[test]
fn any_concurrent_limit_2() {
    any_concurrent_limit(2);
}

#[cfg_attr(feature = "ci", ignore)]
#[test]
fn any_concurrent_limit_4() {
    any_concurrent_limit(4);
}
