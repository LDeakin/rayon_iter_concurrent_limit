...
fn iter_concurrent_limit_filter(concurrent_limit: usize) {
    ...
    let output = iter_concurrent_limit!(concurrent_limit, (0..10), filter, |i| -> bool {
...
#[test]
fn iter_concurrent_limit_filter_1() {
    iter_concurrent_limit_filter(1);
}

#[test]
fn iter_concurrent_limit_filter_2() {
    iter_concurrent_limit_filter(2);
}

#[cfg_attr(feature = "ci", ignore)]
#[test]
fn iter_concurrent_limit_filter_4() {
    iter_concurrent_limit_filter(4);
}
