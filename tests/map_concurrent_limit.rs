...
fn map_concurrent_limit(concurrent_limit: usize) {
    ...
    let output = (0..10)
        .into_par_iter()
        .map_concurrent_limit(concurrent_limit, |i| {
...
#[test]
fn map_concurrent_limit_1() {
    map_concurrent_limit(1);
}

#[test]
fn map_concurrent_limit_2() {
    map_concurrent_limit(2);
}

#[cfg_attr(feature = "ci", ignore)]
#[test]
fn map_concurrent_limit_4() {
    map_concurrent_limit(4);
}
