...
fn update_concurrent_limit(concurrent_limit: usize) {
    ...
    let output = (0..10)
        .into_par_iter()
        .update_concurrent_limit(concurrent_limit, |i| {
        ...
        .collect::<Vec<_>>();
    assert_eq!(output, (0..10).map(|i| i * 2).collect::<Vec<_>>());
...
#[test]
fn update_concurrent_limit_1() {
    update_concurrent_limit(1);
}

#[test]
fn update_concurrent_limit_2() {
    update_concurrent_limit(2);
}

#[cfg_attr(feature = "ci", ignore)]
#[test]
fn update_concurrent_limit_4() {
    update_concurrent_limit(4);
}
