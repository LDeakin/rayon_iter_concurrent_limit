...
fn filter_concurrent_limit(concurrent_limit: usize) {
    ...
    let output = (0..10)
        .into_par_iter()
        .filter_concurrent_limit(concurrent_limit, |i| {
        ...
        .collect::<Vec<_>>();
    assert_eq!(output, (0..10).filter(|i| i % 2 == 0).collect::<Vec<_>>());
...
#[test]
fn filter_concurrent_limit_1() {
    filter_concurrent_limit(1);
}

#[test]
fn filter_concurrent_limit_2() {
    filter_concurrent_limit(2);
}

#[cfg_attr(feature = "ci", ignore)]
#[test]
fn filter_concurrent_limit_4() {
    filter_concurrent_limit(4);
}
