...
fn iter_concurrent_limit_for_each(concurrent_limit: usize) {
    ...
    iter_concurrent_limit!(concurrent_limit, (0..10).into_par_iter(), for_each, |_| {
...
#[test]
fn iter_concurrent_limit_for_each_1() {
    iter_concurrent_limit_for_each(1);
}

#[test]
fn iter_concurrent_limit_for_each_2() {
    iter_concurrent_limit_for_each(2);
}

#[cfg_attr(feature = "ci", ignore)]
#[test]
fn iter_concurrent_limit_for_each_4() {
    iter_concurrent_limit_for_each(4);
}
